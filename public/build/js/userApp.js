...
var update = __webpack_require__(6)("6bf41622", content, false, {});
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(6)("acf8699a", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
var userApp = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
  router: router,
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_User_vue__ = __webpack_require__(56);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_User_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__components_User_vue__);


var routes = [{
  path: '/',
  name: 'user',
  component: __WEBPACK_IMPORTED_MODULE_0__components_User_vue___default.a,
...
Component.options.__file = "resources/assets/js/user/components/User.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-22aff79c", Component.options)
  } else {
    hotAPI.reload("data-v-22aff79c", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_vue_select__ = __webpack_require__(58);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__message__ = __webpack_require__(59);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__message___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__message__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: _extends({}, Object(__WEBPACK_IMPORTED_MODULE_0_vuex__["b" /* mapActions */])(['get', 'getUserNotes', 'toggleFavourite', 'getUserFavouriteId']), {
    toggleActiveClass: function toggleActiveClass() {
      var note = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
      var setActiveNoteNull = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;

      this.activeNote = setActiveNoteNull ? {} : note ? note : this.userNotes ? this.userNotes[0] : {};
    },
    getFavouriteId: function getFavouriteId() {
      var _this2 = this;

      this.loading = true;
      this.getUserFavouriteId(this.loggedUser.id).then(function (resp) {
        return _this2.favouriteNoteIdList = resp;
      }).finally(function () {
    ...
    toggleFavourite: function toggleFavourite(note, noteIsFavourited) {
      ...
      this.$store.dispatch('toggleFavourite', note.id).then(function () {
        ...
        _this3.$emit('flash', { message: noteIsFavourited ? __WEBPACK_IMPORTED_MODULE_6__message__["noteUnFavouritedSuccessfully"] : __WEBPACK_IMPORTED_MODULE_6__message__["noteFavouritedSuccessfully"] });
      });
    }
  }),
  ...
  watch: {
    selectedUser: function selectedUser() {
      ...
      if (this.selectedUser) {
        this.getUserNotes(this.selectedUser.id).then(function (resp) {});
      } else {
  ...
  return _c(
    ...
    [
      ...
      _c(
        ...
        [
          _c("v-select", {
            attrs: { label: "name", options: _vm.userModule.users },
            model: {
          ...
          _c("div", { staticClass: "container" }, [
            _c("div", { staticClass: "list-group" }, [
              _vm.userModule.userNotes.length && _vm.selectedUser
                ? _c(
                    "div",
                    _vm._l(_vm.userModule.userNotes, function(note) {
                      return _c(
                        "a",
                        {
                          staticClass: "list-group-item",
                          class:
                            _vm.activeNote && _vm.activeNote.id === note.id
                              ? "active"
                              : "",
                          attrs: { href: "#" }
                        },
      ...
      _vm._v(
        "\n    " +
          _vm._s(
            _vm.activeNote && _vm.selectedUser ? _vm.activeNote.description : ""
          ) +
          "\n"
      )
    ],
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-22aff79c", module.exports)
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vuex__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__state__ = __webpack_require__(62);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__actions__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__mutations__ = __webpack_require__(65);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_axios__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_axios___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_axios__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__api__ = __webpack_require__(64);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  get: function get(_ref) {
    ...
    __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get(__WEBPACK_IMPORTED_MODULE_1__api__["a" /* default */]).then(function (resp) {
      return commit('GET', resp.data);
    });
  },
  getUserNotes: function getUserNotes(_ref2, user) {
    var commit = _ref2.commit;

    __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get(__WEBPACK_IMPORTED_MODULE_1__api__["a" /* default */] + '/' + user + '/notes').then(function (resp) {
      return commit('GET_USER_NOTES', resp.data);
    });
  }
});
...
"use strict";
var _GET$GET_USER_NOTES;

function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }

/* harmony default export */ __webpack_exports__["a"] = (_GET$GET_USER_NOTES = {}, _defineProperty(_GET$GET_USER_NOTES, 'GET', function GET(state, users) {
  state.users = users;
